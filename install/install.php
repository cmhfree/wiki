...
INSERT INTO wiki_user(email,username,`password`,`lastip`,groupid,credit1,credit2,regtime) VALUES ('{$admin_email}', '{$admin_master}', '$adminpwd', '{$_SERVER[REMOTE_ADDR]}',4,20,20,'$regtime') ;
