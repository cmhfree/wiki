...
function xml_to_array($data, $isfile = false, $is_iconv = '')
{
	if($isfile)
	{
	...
	$data = object_to_array($data, $is_iconv);
	return $data;
}
...
class thememodel {
	...
	function visual_url($dir,$theme){
	    ...
	    if(is_dir($dir)){
		    ...
		    $cache_file='saemc://hdwiki/data/cache/'.$cachename.'.php';
